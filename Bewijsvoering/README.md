...
### Sprints 1, 2 en 3
Het eerste wat ik heb gedaan op mijn stage is het maken van een [projectplan](https://github.com/Stage-Bravo/Portfolio/blob/main/Overige%20Documenten/Projectplan.pdf). Daarin heb ik de eerste 6 weken gepland aan mijn onderzoek. Dit omvat een onderzoek naar wat een API is en wat de beste manier is om een API op te zetten. [HIER](https://github.com/Stage-Bravo/Portfolio/blob/main/Onderzoek/Onderzoeksrapport.pdf) is het onderzoeksrapport te vinden. <br>
