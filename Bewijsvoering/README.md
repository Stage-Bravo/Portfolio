...
Het appliactie onderzoek heb ik uitgesteld omdat er niet met OOP geserkt is maar nu dat ik verder ben heb ik opgeschreven hoe de applicatie er nu uitziet vergelegen met hoe we het op school aangeleerd hebben. Hier heb ik de voor en nadelen van opgeschreven. Naast dat heb ik beschreven hoe de API in het project gedesigned is. Dat onderzoek kun je [HIER](https://github.com/Stage-Bravo/Portfolio/blob/main/Onderzoek/Onderzoeksrapport.pdf) vinden.
